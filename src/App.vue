...
<!-- <div class="doPhoto">
  <img src="/src/assets/ppr2.png" alt="" class="photo">
</div> -->



  <section class="bg-slate-50 dark:bg-gray-800 rounded-xl w-full testPhoto">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
  ...
  <section class="bg-slate-50 dark:bg-gray-800 rounded-xl w-full testPhoto mt-5">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <h1 class="mb-4 mt-5 text-4xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">{{ selected }}</span></h1>


        <form class="max-w-sm mx-auto mt-10">
          <select v-model="selected" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
           <option disabled value="">Выберите один из вариантов:</option>
            <option value="195">Июль</option>
            <option value="CA">Сентябрь</option>
